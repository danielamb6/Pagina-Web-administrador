...
function inicializarEventos() {
    ...
    document.getElementById('btn-descargar-final').addEventListener('click', function() {
...
function descargarPDFFinal() {
    ...
    // --- REVERTIDO AL FORMATO ANTERIOR (VERSIÓN 1: CUADROS Y TABLA FINAL) ---
    ...
    // Métricas (Rectangulos dibujados)
    pdf.setFontSize(14);
